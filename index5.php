...
<head>
  ...
  <style>
    /* Màu thương hiệu */
    :root {
      --pg-red-dark: #A32E2E;     /* Đỏ nâu */
      --pg-red: #D62828;          /* Đỏ tươi */
      --pg-yellow: #FFE324;       /* Vàng tươi */
      --pg-yellow-light: #FFE566; /* Vàng nhạt */
      --pg-blue-zalo: #008FFF;
    }
    ...
    .main-menu {
      background: var(--pg-red-dark);
      border-top: 3px solid var(--pg-yellow);
      border-bottom: 3px solid var(--pg-yellow);
      margin-top: 12px;
    }
